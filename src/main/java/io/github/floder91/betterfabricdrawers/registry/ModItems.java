...
public class ModItems {
    ...
    public static final UpgradeItem T1_UPGRADE = new UpgradeItem(new FabricItemSettings(), BetterFabricDrawers.id("item/t1_upgrade"), (int) getCapacityT1());
    public static final UpgradeItem T2_UPGRADE = new UpgradeItem(new FabricItemSettings(), BetterFabricDrawers.id("item/t2_upgrade"), (int) getCapacityT2());
    public static final UpgradeItem T3_UPGRADE = new UpgradeItem(new FabricItemSettings(), BetterFabricDrawers.id("item/t3_upgrade"), (int) getCapacityT3());
    public static final UpgradeItem T4_UPGRADE = new UpgradeItem(new FabricItemSettings(), BetterFabricDrawers.id("item/t4_upgrade"), (int) getCapacityT4());
