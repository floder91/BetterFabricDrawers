...
import io.github.floder91.betterfabricdrawers.registry.ModItems;
...
class DrawersModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator generator) {
        ...
        generator.registerSingleton(ModBlocks.CONNECTOR, TextureMap.all(BetterFabricDrawers.id("block/drawer_base")), Models.CUBE_ALL);
        ...
        generator.registerNorthDefaultHorizontalRotatable(ModBlocks.SHADOW_DRAWER,
                TextureMap.sideEnd(BetterFabricDrawers.id("block/shadow_drawer_side"), BetterFabricDrawers.id("block/shadow_drawer_side")));
    }
    ...
    private void registerDrawerModel(Block block, BlockStateModelGenerator generator) {
        var template = new Model(Optional.of(BetterFabricDrawers.id("drawer_template")), Optional.empty(), TextureKey.FRONT);
