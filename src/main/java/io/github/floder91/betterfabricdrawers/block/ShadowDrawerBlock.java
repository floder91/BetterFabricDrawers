...
import io.github.floder91.betterfabricdrawers.network.NetworkStorageCache;
import io.github.floder91.betterfabricdrawers.network.node.ShadowDrawerBlockNode;
...
public class ShadowDrawerBlock extends NetworkBlockWithEntity<ShadowDrawerBlockEntity> implements CreativeBreakBlocker, DrawerInteractionHandler {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        var isDoubleClick = DrawerInteractionStatusManager.getAndResetInsertStatus(player, pos, 0);
