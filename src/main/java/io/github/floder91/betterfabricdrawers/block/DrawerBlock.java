...
import io.github.floder91.betterfabricdrawers.misc.DrawerInteractionStatusManager;
import io.github.floder91.betterfabricdrawers.misc.DrawerRaycastUtil;
...
import io.github.floder91.betterfabricdrawers.block.base.NetworkBlockWithEntity;
import io.github.floder91.betterfabricdrawers.block.base.NetworkComponent;
...
import io.github.floder91.betterfabricdrawers.network.node.DrawerBlockNode;
...
public class DrawerBlock extends NetworkBlockWithEntity<DrawerBlockEntity> implements DrawerInteractionHandler, CreativeBreakBlocker, NetworkComponent {
    ...
    public ActionResult upgrade(BlockState state, World world, BlockPos pos, Vec3d hitPos, Direction side, PlayerEntity player, ItemStack stack) {
        ...
        if (!(stack.getItem() instanceof UpgradeItem upgrade)) {
            BetterFabricDrawers.LOGGER.warn("Expected drawer upgrade to be UpgradeItem but found " + stack.getItem().getClass().getSimpleName() + " instead");
